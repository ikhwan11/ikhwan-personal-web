<div>
    <!-- Start Home -->
    <section class="bg-[url('/assets/img/slider/1.jpg')] flex items-center dark:bg-[url('/assets/img/slider/2.jpg')] bg-center bg-cover lg:h-screen py-24 relative dizme_tm_header" id="home">
        <div class="container">
            <div class="grid lg:grid-cols-2 items-center gap-[25px]">
                <div class="order-2 lg:order-1">
                    ...
                    <p class="lg:mb-9 mb-[15px] text-lg lg:text-[19px] xl:text-[28px] text-center lg:text-left font-medium">
                        A <span class="text-[#1cbe59]">Creative Designer</span> From <span class="text-[#8067f0] dark:text-[#f0c45c]">Indonesia</span>
                    </p>
                ...
                <div class="order-1 lg:order-2">
                    <div class="relative">
                        <img src="/assets/img/slider/avatar.jpg" class="mx-auto max-w-[250px] lg:max-w-[400px] xl:max-w-[650px]" alt="" />
    ...
    <livewire:FrontPartnerSection />
    <livewire:FrontTestimonialSection />
