        ...
        <div class="container">
            <div class="grid grid-cols-1">
                <div class="text-center max-w-[680px] mx-auto">
                    ...
                    <p class="text-muted text-lg leading-[30px]">Please fill out the form on this section to contact with me. Or call between 9:00 a.m. and 05:00 p.m. , Monday through Friday</p>
                </div>
            </div>
                ...
                <div class="space-y-[15px] wow fadeInLeft" data-wow-duration="1s">
                    <div class="flex items-center gap-[25px]">
                        ...
                        <div>
                            ...
                            <p class="text-lg mt-1.5 text-muted leading-8">Batam, Indonesia</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-[25px]">
                    ...
                    <div class="flex items-center gap-[25px]">
                        ...
                        <div>
                            ...
                            <p class="text-lg mt-1.5 text-muted leading-8">+62896-2354-7669</p>
                        </div>
                    </div>
                </div>
